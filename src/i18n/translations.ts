...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "app.exportPng": "Exporter la carte en PNG",
    ...
    "app.year.labelB": "Année (carte 2)",
    "app.year.play": "Lire l'évolution",
    "app.year.pause": "Pause",
    "app.year.speed": "Vitesse de lecture",
    ...
    "app.scale.label": "Échelle",
    "app.scale.quantiles": "Quantiles (auto)",
    "app.scale.equal": "Classes égales",
    "app.scale.fixed": "Valeurs fixes",
    "app.scale.mean": "Moyenne au centre",
    "app.scale.median": "Médiane au centre",
    "app.scale.custom": "Personnalisé",
    "app.scale.customPlaceholder": "Seuils ex : 5, 15, 30, 50, 75",
    ...
    "map.legend.mode.quantiles": "(quantiles)",
    "map.legend.mode.equal": "(classes égales)",
    "map.legend.mode.fixed": "(valeurs fixes)",
    "map.legend.mode.mean": "(moyenne)",
    "map.legend.mode.median": "(médiane)",
    "map.legend.mode.custom": "(personnalisé)",
    "map.legend.na": "N/A",
    "map.na": "N/A",
  ...
  en: {
    ...
    "app.exportPng": "Export map as PNG",
    ...
    "app.year.label": "Year",
    "app.year.labelB": "Year (map 2)",
    "app.year.play": "Play evolution",
    "app.year.pause": "Pause",
    "app.year.speed": "Playback speed",
    ...
    "app.scale.label": "Scale",
    "app.scale.quantiles": "Quantiles (auto)",
    "app.scale.equal": "Equal classes",
    "app.scale.fixed": "Fixed values",
    "app.scale.mean": "Mean-centered",
    "app.scale.median": "Median-centered",
    "app.scale.custom": "Custom",
    "app.scale.customPlaceholder": "Thresholds e.g. 5, 15, 30, 50, 75",
    ...
    "map.legend.quantiles": "(quantiles)",
    "map.legend.mode.quantiles": "(quantiles)",
    "map.legend.mode.equal": "(equal classes)",
    "map.legend.mode.fixed": "(fixed values)",
    "map.legend.mode.mean": "(mean)",
    "map.legend.mode.median": "(median)",
    "map.legend.mode.custom": "(custom)",
    "map.legend.na": "N/A",
    "map.na": "N/A",
