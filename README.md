...
- 📅 **Year slider** (1960-2025): full re-color of map, legend, ranks and tooltips on the selected year — **per-map year in dual mode** (`?year=&yearB=`) + **▶ play button** (auto-scroll animation, synced in dual)
